...
const JadeCoreAbout = {
    ...
    DOM: {
        ...
        navNavigation: document.querySelector('#mainNavigation'),
        navToggle: document.querySelector('.mobile-nav-toggle'),
        teamCards: document.querySelectorAll('.team-card'),
        memberTags: document.querySelectorAll('.member-tag'),
        ecosystemContainer: document.querySelector('.ecosystem-graphic-placeholder')
    },
    ...
    initTeamAnimations: function() {
        if (this.DOM.teamCards.length === 0) return;
